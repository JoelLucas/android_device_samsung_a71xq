...
# Kernel
TARGET_PREBUILT_KERNEL := device/samsung/a71xq/prebuilt/Image.gz
TARGET_PREBUILT_DTB := device/samsung/a71xq/prebuilt/dtb
BOARD_PREBUILT_DTBOIMAGE := device/samsung/a71xq/prebuilt/recoverydtbo
...
BOARD_MKBOOTIMG_ARGS += --header_version $(BOARD_BOOT_HEADER_VERSION) --pagesize $(BOARD_KERNEL_PAGESIZE) --board "SRPTA15A001"
BOARD_MKBOOTIMG_ARGS += --dtb $(TARGET_PREBUILT_DTB) --dtb_offset $(BOARD_DTB_OFFSET)
BOARD_CUSTOM_BOOTIMG_MK := device/samsung/a71xq/bootimg.mk
...
# Dynamic Partitions
BOARD_SUPER_PARTITION_SIZE := 9739173888
BOARD_SUPER_PARTITION_GROUPS := samsung_dynamic_partitions
BOARD_SAMSUNG_DYNAMIC_PARTITIONS_SIZE := 7562182656
...
TW_DEVICE_VERSION := 4_afaneh92-Q
